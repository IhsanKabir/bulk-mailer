...
# no app registration). Tried in this order until one is allowed by the tenant:
#
...
#      admin consent for it (blocking it would break Office itself), and it is
...
#      The Graph CLI id — our original default. The usbair tenant returned
#      "Need admin approval" for it (seen 2026-06-12), hence Office is now first.
#
# Override without code changes: put a client id (one line) in
# %LOCALAPPDATA%/BulkMailer/graph_client_id.txt and it is used instead.
